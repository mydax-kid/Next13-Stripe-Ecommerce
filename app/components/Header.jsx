...
export default function Header() {
    ...
    return (
        <header className='sticky top-0 p-6 bg-white border-b border-solid border-blue-900 shadow-md z-50 text-2xl sm:text-3xl md:text-4xl sm:p-8 lg:px-12 flex item-center justify-between'>
            {openModal && (
                <Modal />
            )}
            <Link href={'/'}>
                <h1 className='uppercase font-bold text-orange-500 cursor-pointer hover:scale-110'>Fruit Shop</h1>
            </Link>
